...
/**
 * Created by commando4 on 8/4/2018.
 */

public class TotalEmployeeAdapter extends BaseAdapter {
    ...
    public TotalEmployeeAdapter(Context context, ArrayList<PresentNamePoJo> items) {
        mContext = context;
        mDataSource = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = mInflater.inflate(R.layout.total_team_list_item, parent, false);
