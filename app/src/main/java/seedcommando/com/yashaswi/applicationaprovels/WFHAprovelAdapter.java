        ...
        Aprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(mContext, "Application Aproved", Toast.LENGTH_LONG).show();
                    ...
                    sendAppAprovalsForApprove(EmpowerApplication.aesAlgorithm.Decrypt(EmpowerApplication.get_session("employeeId")),inTime.getTag().toString(),outTime.getTag().toString(),"0");
