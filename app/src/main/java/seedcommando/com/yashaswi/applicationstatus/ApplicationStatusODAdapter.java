...
public class ApplicationStatusODAdapter extends BaseAdapter {
                ...
                alertDialogBuilder.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                DeleteOutDutyApp(EmpowerApplication.aesAlgorithm.Decrypt(EmpowerApplication.get_session("employeeId")), EmpowerApplication.aesAlgorithm.Decrypt(EmpowerApplication.get_session("data")),applicationStatusPOJO.getOutDutyAppID());
    ...
    public void DeleteOutDutyApp(String employeecode, String token, String OutDutyAppID) {
